...
//------------------root6----------------------SSID and Password of your WiFi router-------------------------------------------------------------------------------------------------------------//
const char* ssid = "Roo";
const char* password = "pwwwsebtc25@!#";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void setup() {
  ...
  Serial.println("");
  if (mfrc522.PCD_PerformSelfTest()) {Serial.println("Passed Self-Test");}else{Serial.println("TESTPA");}
}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  digitalWrite(ON_Board_LED, LOW);
    ...
    String UIDresultSend, postData,haltx;
    UIDresultSend = StrUID;
    
   String hltx= "Panadura Halt";
    //Post Data
    postData = "UIDresult=" + UIDresultSend+ "&station="+hltx ;
  
  
 
   http.begin("http://bustraintracker.000webhostapp.com/getUID.php");
   http.addHeader("Content-Type", "application/x-www-form-urlencoded"); 

 http.begin("http://bustraintracker.000webhostapp.com/tagreadtest.php");//Specify request destination
